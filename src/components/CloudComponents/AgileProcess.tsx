...
interface AgileProcessProps {
  process: ProcessPhase[]
  providerName: string
}

export default function AgileProcess({ process, providerName }: AgileProcessProps) {
  return (
      ...
      <MaxWidthWrapper>
        ...
        >
          ...
          <p className="text-lg md:text-xl text-gray-600 max-w-3xl mx-auto">
            A proven methodology for successful {providerName} implementation
          </p>
        </motion.div>
